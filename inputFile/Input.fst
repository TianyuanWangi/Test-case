...
100.0000                                                    TMax            - Total run time (s)
...
2                                                           CompHydro       - Compute hydrodynamic loads (switch) {0=none; 1=HydroDyn}
...
"./BeamDyn_blade.dat"                                       BDBldFile(1)    - Name of file containing BeamDyn input parameters for blade 1 (quoted string)
"./BeamDyn_blade.dat"                                       BDBldFile(2)    - Name of file containing BeamDyn input parameters for blade 2 (quoted string)
"./BeamDyn_blade.dat"                                       BDBldFile(3)    - Name of file containing BeamDyn input parameters for blade 3 (quoted string)
...
"./MoorDyn.dat"                                             MooringFile     - Name of file containing mooring system input parameters (quoted string)
"./IceDyn.dat"                                              IceFile         - Name of file containing ice input parameters (quoted string) 
----------------------------------------------------------- OUTPUT 
